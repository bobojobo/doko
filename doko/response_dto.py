...
class GameCard(BaseModel):
    ...
    def suit_symbol(self) -> str:
        ...
        from doko.game.card import Suit
        return Suit.symbol_from_name(self.suit)
    
    @computed_field  # type: ignore
    @property
    def rank_abbrev(self) -> str:
        """Return the standard card abbreviation for the rank."""
        from doko.game.card import Rank
        return Rank.abbreviation_from_name(self.rank)
