...
class Rank(Enum):
    ...
    def abbreviation(self) -> str:
        """Return the standard card abbreviation for this rank."""
        abbrev_map = {
            Rank.ace: "A",
            Rank.ten: "10",
            Rank.king: "K",
    ...
    @staticmethod
    def abbreviation_from_name(rank_name: str) -> str:
        """Return the standard card abbreviation for a rank given its name."""
        abbrev_map = {
            "ace": "A",
            "ten": "10",
            "king": "K",
        ...
        return abbrev_map.get(rank_name, rank_name)
...
class Suit(Enum):
    ...
    @staticmethod
    def symbol_from_name(suit_name: str) -> str:
        """Return the Unicode symbol for a suit given its name."""
        suit_map = {
            "clubs": "♣️",
            "spades": "♠️", 
            "hearts": "♥️",
        ...
        return suit_map.get(suit_name, suit_name)
...
class Card:
    ...
    def display(self) -> str:
        """Return a display string with rank abbreviations and suit symbols."""
        return f"{self.rank.abbreviation()} {self.suit.symbol()}"
